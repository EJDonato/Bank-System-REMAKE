...
class CustomerFacade:
    ...
    def sign_up(self, email, password, first_name, last_name, birthdate, pin, monthly_salary, initial_balance):
        self.bank_account = BankAccount(email, password, first_name, last_name, birthdate, pin, monthly_salary, initial_balance)
        success = self.signup.insert_acc_info_to_database(self.bank_account)
